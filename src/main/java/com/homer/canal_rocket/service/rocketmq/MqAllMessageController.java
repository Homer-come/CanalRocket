...
import com.homer.canal_rocket.service.rocketmq.listener.SendCallbackListener;
import com.homer.canal_rocket.service.rocketmq.model.OrderStep;
import com.homer.canal_rocket.util.ListSplitter;
import com.homer.canal_rocket.web.MqMessageController;
...
public class MqAllMessageController {
  private static final Logger log = LoggerFactory.getLogger(MqAllMessageController.class);
  ...
  public AjaxReturnBean pushMessage(@RequestParam("id") int id) {
    ...
    if (sendResult.getSendStatus() == SendStatus.SEND_OK) {
      return AjaxReturnBean.createSuccess(sendResult.getMsgId() + " : " + sendResult.getSendStatus());
    }
    return AjaxReturnBean.createError("");
  }
  ...
  public AjaxReturnBean pushAsyncMessage(@RequestParam("id") int id) {
  ...
  public AjaxReturnBean pushOneWayMessage(@RequestParam("id") int id) {
  ...
  public AjaxReturnBean pushSequeueMessage(@RequestParam("id") int id) {
  ...
  public AjaxReturnBean pushDelayMessage(@RequestParam("id") int id) {
  ...
  public AjaxReturnBean pushBatchMessage(@RequestParam("id") int id) {
  ...
  public AjaxReturnBean pushSqlMessage(@RequestParam("id") int id) {
  ...
  public AjaxReturnBean pushTransactionMessage(@RequestParam("id") int id) {
